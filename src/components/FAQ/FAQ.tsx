...
export function FAQ() {
  ...
  const faqs: FAQItem[] = [
    ...
    // },
    {
      ...
      answer: "אני מציע שני מסלולים גמישים: מסלול רכישה חד-פעמית (₪700) שבו משלמים פעם אחת על הבנייה והאתר שלכם לתמיד, ומסלול חודשי (₪400 לחודש כולל מע\"מ) בהתחייבות לשנה, המאפשר לכם להקים אתר ללא עלות הקמה גדולה וליהנות מניהול ועדכונים שוטפים הכלולים במחיר."
    },
    {
